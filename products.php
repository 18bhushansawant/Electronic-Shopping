...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Shopping <br>Store!</h1>
			  ...
			  <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/one1.jpg" alt="OnePlus 7T">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>OnePlus 7T</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/one2.jpg" alt="Redmi K20 Pro">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Redmi K20 Pro</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/one3.jpg" alt="Huawei P30 Pro ">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/one4.jpg" alt="OPPO Reno 2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>OPPO Reno 2</h3>
